        ...
        <div className="max-w-[95rem] px-6 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          <div className="grid lg:grid-cols-2 gap-6">
            {Array.from({ length: size }).map((_, index) => (
              <div
                key={index}
                className="group sm:flex rounded-xl"
                role="status"
              >
                <div className="flex items-center justify-center bg-gray-300 dark:bg-gray-700 flex-shrink-0 relative rounded-xl overflow-hidden w-[300px] h-[400px] animate-pulse">
                  <svg
                ...
                <div className="grow">
                  <div className="p-4 flex flex-col h-full sm:p-6 animate-pulse">
                    ...
                    <div className="mt-5 sm:mt-auto">
                      <button className="w-full px-16 py-5 mt-6 tracking-wider uppercase transition-colors duration-500 transform bg-gray-200 dark:bg-gray-700 rounded-lg lg:w-auto"></button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="grow">
                  <div className="p-4 flex flex-col h-full sm:p-6">
                    <h3 className="text-lg sm:text-2xl font-semibold text-gray-800 group-hover:text-blue-600 dark:text-gray-500 transition-colors duration-500">
                      {tvShow.name}
                    </h3>
                    <p className="mt-2 text-gray-600 dark:text-gray-400 transition-colors duration-500">
                      {tvShow.overview !== ""
                        ? tvShow.overview.length > 250
                          ? tvShow.overview.substring(0, 250) + "..."
                          : tvShow.overview
                        : "N/A"}
                    </p>
                    <div className="mt-5 sm:mt-auto">
                      <Link to={`/tv-show/${tvShow.id}`}>
                        <button className="w-full px-5 py-2 mt-6 text-sm tracking-wider text-white uppercase transition-colors duration-500 transform bg-blue-600 rounded-lg lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
                          Read more
                        </button>
                      </Link>
                    </div>
