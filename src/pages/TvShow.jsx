  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center min-h-screen">
        <Navbar />
        {isLoading ? (
          <section className="pt-20 pb-8 mx-auto">
            <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-10 flex flex-col md:flex-row gap-8 md:gap-20 lg:gap-32 py-10 rounded-2xl">
              <div className="flex md:flex-1">
                <div className="flex items-center justify-center bg-gray-300 dark:bg-gray-700 flex-shrink-0 relative rounded-xl overflow-hidden w-[275px] h-[400px] md:w-[300px] md:h-[600px] lg:w-[475px] lg:h-[700px] animate-pulse">
                  <svg
          ...
          <section className="pt-20 mx-auto">
            <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-10 flex flex-col md:flex-row gap-8 md:gap-16 py-10 rounded-2xl">
              <div className="flex md:flex-1">
                {data.poster_path ? (
                  <div className="flex md:flex-1">
                    <img
                  ...
                  <div className="flex items-center justify-center bg-gray-300 dark:bg-gray-700 flex-shrink-0 relative rounded-xl overflow-hidden w-[275px] h-[400px] md:w-[300px] md:h-[600px] lg:w-[475px] lg:h-[700px]">
                    <svg
                      className="w-10 h-10 text-gray-200 dark:text-gray-600"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="md:w-1/2 space-y-4 lg:space-y-8 text-gray-700 dark:text-gray-300 transition duration-500">
                <h1 className="h-12 text-transparent bg-clip-text bg-gradient-to-br from-blue-600 from-20% via-indigo-400 via-30% to-teal-600 font-semibold text-2xl sm:text-3xl md:text-4xl">
                  {data.name}
                </h1>
                <p>{data.overview}</p>
                <ul className="space-y-4">
                  <li className="flex items-center gap-x-4">
                    ...
                    Status: {data.in_production ? "Ongoing" : "Finished"}
                  </li>
                  <li className="flex items-center gap-x-4">
                    <span className="w-5 h-5 text-sm flex items-center justify-center rounded-full bg-emerald-700 dark:bg-emerald-600 text-white">
                      ✓
