        ...
        <div className="container pt-24 w-full max-w-[95rem] mx-auto px-5 sm:px-10 md:px-12 lg:px-5">
          <div className="w-full relative py-8 md:py-10 px-6 md:px-8 rounded-2xl bg-gradient-to-tr from-gray-100 to-gray-200 dark:from-gray-900">
            ...
            <div className="mx-auto text-center max-w-xl md:max-w-2xl relative space-y-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 transition duration-500">
                Discover a wide range of thrilling movies currently in theaters
                or available for streaming. Whether you&apos;re into action,
                romance, or comedy, we&apos;ve got something for everyone!
              </p>
            </div>
          </div>
          ...
          <section className="flex items-center py-8">
            <div className="w-full max-w-screen-7xl mx-auto">
              <nav className="flex flex-col items-start justify-between p-4 space-y-3 md:flex-row md:items-center md:space-y-0 md:justify-end">
                <select
                ...
                <ul className="inline-flex items-stretch -space-x-px">
                  ...
                  <li>
                    <a
                      href="#"
                      aria-current="page"
                      className="z-10 flex items-center justify-center px-3 py-2 text-sm leading-tight border text-primary-600 bg-primary-50 border-primary-300 hover:bg-primary-100 hover:text-primary-800 dark:border-gray-800 dark:bg-gray-800 dark:text-white transition duration-500"
                    >
                      {currentPage}
                    </a>
                  </li>
