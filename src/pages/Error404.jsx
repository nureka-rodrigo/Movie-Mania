        ...
        <div className="container flex items-center justify-center min-h-screen px-6 py-12 mx-auto">
          <div className="w-full ">
            <div className="flex flex-col items-center max-w-lg mx-auto text-center">
              ...
              <h1 className="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">We lost this
                page</h1>
              <p className="mt-4 text-gray-500 dark:text-gray-400">We searched high and low, but couldn’t find what
            ...
            <div className="grid w-full max-w-6xl grid-cols-1 gap-8 mx-auto mt-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="p-6 rounded-lg bg-blue-50 dark:bg-gray-900">
                ...
                <h3 className="mt-6 font-medium text-gray-700 dark:text-gray-200 ">Movies</h3>

                <p className="mt-2 text-gray-500 dark:text-gray-400 ">Dive in to learn about new movies.</p>
              ...
              <div className="p-6 rounded-lg bg-blue-50 dark:bg-gray-900">
                ...
                <h3 className="mt-6 font-medium text-gray-700 dark:text-gray-200 ">TV Shows</h3>

                <p className="mt-2 text-gray-500 dark:text-gray-400 ">Dive in to learn about new TV shows.</p>
              ...
              <div className="p-6 rounded-lg bg-blue-50 dark:bg-gray-900">
                ...
                <h3 className="mt-6 font-medium text-gray-700 dark:text-gray-200 ">Contact Us</h3>
